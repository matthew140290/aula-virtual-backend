...
exports.getVistaRecursoEstudiante = exports.findContextoAcademicoByDocente = exports.ocultarEventoEstudiante = exports.findEventosProximosByEstudiante = exports.findAsignaturasByEstudiante = exports.findEstudiantesByAsignatura = void 0;
// src/services/estudiante.service.ts
const mssql_1 = __importDefault(require("mssql"));
const dbPool_1 = require("../config/dbPool");
const findEstudiantesByAsignatura = async (codigoAsignatura) => {
...
exports.findEstudiantesByAsignatura = findEstudiantesByAsignatura;
const findAsignaturasByEstudiante = async (matriculaNo) => {
    const idBusqueda = Math.abs(matriculaNo);
    try {
        const pool = await dbPool_1.poolPromise;
        const result = await pool.request()
            .input('matriculaNo', mssql_1.default.Int, idBusqueda)
            .query(`
                SELECT 
...
const findEventosProximosByEstudiante = async (matriculaNo) => {
    const pool = await dbPool_1.poolPromise;
    const idPositivo = Math.abs(matriculaNo);
    const result = await pool.request()
        .input('matriculaNo', mssql_1.default.Int, idPositivo)
        .query(`
            SELECT TOP 20
                r.RecursoID as id,
...
exports.findEventosProximosByEstudiante = findEventosProximosByEstudiante;
const ocultarEventoEstudiante = async (matriculaNo, recursoId) => {
    const pool = await dbPool_1.poolPromise;
    const idPositivo = Math.abs(matriculaNo);
    const userCheck = await pool.request()
        .input('matricula', mssql_1.default.Int, idPositivo)
    ...
    await pool.request()
        .input('matriculaNo', mssql_1.default.Int, idParaInsertar)
...
exports.ocultarEventoEstudiante = ocultarEventoEstudiante;
const findContextoAcademicoByDocente = async (codigoDocente) => {
    const pool = await dbPool_1.poolPromise;
    const result = await pool.request()
...
exports.findContextoAcademicoByDocente = findContextoAcademicoByDocente;
const getVistaRecursoEstudiante = async (recursoId, matriculaNo) => {
    const pool = await dbPool_1.poolPromise;
    const now = new Date();
...
exports.getVistaRecursoEstudiante = getVistaRecursoEstudiante;
