...
const recurso_service_1 = require("./recurso.service");
describe('recurso.service personalized audience access', () => {
    ...
    it('allows access to non-personalized resources', async () => {
        ...
        await expect((0, recurso_service_1.estudiantePuedeAccederRecurso)(10, 123)).resolves.toBe(true);
    });
    ...
    it('denies access to non-selected students for personalized resources', async () => {
        ...
        await expect((0, recurso_service_1.estudiantePuedeAccederRecurso)(10, 999)).resolves.toBe(false);
    });
    it('denies access for invalid identifiers', async () => {
        await expect((0, recurso_service_1.estudiantePuedeAccederRecurso)(Number.NaN, 123)).resolves.toBe(false);
