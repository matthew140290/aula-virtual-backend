...
exports.getTimelineActividad = exports.getResumenAcademico = exports.getInfoBasica = exports.buscarEstudiantes = void 0;
...
const buscarEstudiantes = async (query) => {
    ...
    const result = await pool.request()
        .input('search', mssql_1.default.NVarChar(200), `%${searchTerm}%`)
        .query(`
            SELECT TOP 20
...
// ==========================================
const getInfoBasica = async (matriculaNo) => {
    const pool = await dbPool_1.poolPromise;
    const result = await pool.request()
...
exports.getInfoBasica = getInfoBasica;
// ==========================================
// RESUMEN ACADEMICO POR ASIGNATURA
// ==========================================
const getResumenAcademico = async (matriculaNo) => {
    const pool = await dbPool_1.poolPromise;
    const result = await pool.request()
        .input('matriculaNo', mssql_1.default.Int, matriculaNo)
        .query(`
...
exports.getResumenAcademico = getResumenAcademico;
// ==========================================
// TIMELINE DE ACTIVIDAD
// ==========================================
const getTimelineActividad = async (matriculaNo, limite = 100) => {
    const pool = await dbPool_1.poolPromise;
...
exports.getTimelineActividad = getTimelineActividad;
